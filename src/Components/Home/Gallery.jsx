  ...
  return (
    <div>
      <section className="mt-20">
        ...
        >
          <div className="h-80" data-aos="fade-right">
            <img
          ...
          <div className="h-80" data-aos="fade-left">
            <img
          ...
          <div className="h-80" data-aos="fade-up-left">
            <img
          ...
          <div className="h-80" data-aos="fade-up-right">
            <img
          ...
          <div className="h-80" data-aos="flip-left">
            <img
          ...
          <div className="h-80" data-aos="flip-right">
            <img
